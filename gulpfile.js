...
{
	return gulp.src('./src/resources/img/**').pipe(gulp.dest('./dist/resources/img'));
});

gulp.task('copy-fonts-1', function()
{
	return gulp.src('./src/resources/fonts/**').pipe(gulp.dest('./dist/resources/fonts'));
});

gulp.task('copy-fonts-2', function()
{
	return gulp.src('./src/resources/lib/fonts/**').pipe(gulp.dest('./dist/resources/fonts'));
});
